...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="hero-section text-center text-white d-flex align-items-center position-relative" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmBPo3TywsSDcRtTHMX0BK9bHbRmOQP30EfHF_wl7QyA&s=10') no-repeat center center/cover;">
        <div class="container px-4">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center gap-3 gap-sm-4 mt-4">
                <?php if (isset($_SESSION['userRole'])): ?>
